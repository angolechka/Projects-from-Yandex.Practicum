...
| -------------                    |-------------           | -------------          |     
| [Прнятие решений в бизнесе](Принятие решений в бизнесе.ipynb)|Основная цель исследования — проверить гипотезы <br /> для увеличения выручки крупного интернет-магазина. |`pandas`, `numpy`, `matplotlib`, `scipy`, `seaborn`, `datetime`|
