...
| -------------                    |-------------           | -------------          |     
| [Прнятие решений в бизнесе](https://github.com/angolechka/portfolio/blob/main/Принятие%20решений%20в%20бизнесе.ipynb)|Основная цель исследования — проверить гипотезы <br /> для увеличения выручки крупного интернет-магазина. |`pandas`, `numpy`, `matplotlib`, `scipy`, `seaborn`, `datetime`|
